...
def build_config(method: str) -> dict[str, Any]:
    ...
    config["experiments"] = [{"name": "central_mixed_obstacles", "episodes": 1, "obstacle_count": 3, "target_speed_scale": 0.55}]
    return config
...
def main() -> None:
    ...
    prototype = CaptureRadiusPursuit3DEnv(config, obstacle_count=3, target_speed_scale=0.55)
