...
- Raw Cooperative Safe Capture: `2/60`; collision `96.7%`.
- CBF Cooperative Safe Capture: `58/60`; collision `1.7%`; boundary `1.7%`.
- Raw failure stages: `{'safety_failure': 58}`.
- CBF failure stages: `{'safety_failure': 1, 'timeout': 1}`.
