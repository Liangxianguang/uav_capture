...
- Raw Cooperative Safe Capture: `0/60`; collision `100.0%`.
- CBF Cooperative Safe Capture: `41/60`; collision `0.0%`; boundary `0.0%`.
- Raw failure stages: `{'safety_failure': 60}`.
- CBF failure stages: `{'timeout': 19}`.

## Fixed-scene regression

- `s1_cylinder` CBF Cooperative Safe Capture: `35.0%`.
- `s1_box` CBF Cooperative Safe Capture: `45.0%`.
- `s1_wall` CBF Cooperative Safe Capture: `50.0%`.
- `s2` CBF Cooperative Safe Capture: `45.0%`.
