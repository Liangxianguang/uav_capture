...
**下一步唯一动作：** 针对 pairwise interaction tail 审计 relative velocity、formation topology 和 hard-tail 覆盖；在 calibration pairwise hazard recall/precision 达标前不训练 full JEPA、不构建新 Ledger、不运行闭环。
