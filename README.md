...
- [DN-MPC P13 pairwise outcome-label contract stop](docs/DN_MPC_P13_PAIRWISE_OUTCOME_LABEL_CONTRACT_STOP_20260908.md)
...
- [DN-MPC P27 fresh calibration and disagreement audit](docs/DN_MPC_P27_FRESH_CALIBRATION_20260908.md)
- [DN-MPC P28 hard-negative replay and augmented JEPA audit](docs/DN_MPC_P28_HARD_NEGATIVE_AND_AUGMENTED_JEPA_20260908.md)
...
- [DN-MPC P25 traceable counterfactual archive audit](docs/DN_MPC_P25_TRACEABLE_COUNTERFACTUAL_ARCHIVE_AUDIT_20260908.md)
- [DN-MPC P25 traceable route-progress audit](docs/DN_MPC_P25_TRACEABLE_ROUTE_PROGRESS_AUDIT_20260908.md)
- [DN-MPC P26 planner-abstention audit](docs/DN_MPC_P26_PLANNER_ABSTENTION_AUDIT_20260908.md)
