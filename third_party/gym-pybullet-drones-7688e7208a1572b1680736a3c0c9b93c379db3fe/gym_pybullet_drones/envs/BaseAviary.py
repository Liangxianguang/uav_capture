...
class BaseAviary(gym.Env):
    ...
    def __init__(self,
        ...
        self.DEFORMABLE_WORLD = deformable_world
    ...
    def reset(self):
        ...
        """
        reset_flags = p.RESET_USE_DEFORMABLE_WORLD if self.DEFORMABLE_WORLD else 0
        p.resetSimulation(reset_flags, physicsClientId=self.CLIENT)
        #### Housekeeping ##########################################
        self._housekeeping()
        #### Update and store the drones kinematic information #####
        self._updateAndStoreKinematicInformation()
    ...
    def _parseURDFParameters(self):
        ...
        # J is diagonal for the Crazyflie URDF; invert it elementwise to
        # avoid a BLAS/OpenMP runtime collision with PyTorch on Windows.
        J_INV = np.diag([1.0 / IXX, 1.0 / IYY, 1.0 / IZZ])
